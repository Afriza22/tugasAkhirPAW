...
<html lang="en">
  ...
  <div class="bg-primary d-flex justify-content-center align-items-center" style="height:100vh">
    <div class="bg-light py-5 px-3 rounded shadow position-relative" style="width:300px">
        <h1 class="text-center text-primary fw-bold mb-5">LOGIN</h1>
        <form action="auth.php" method="post">
            ...
            <p class="text-secondary text-center mt-4" style="font-size: 10px;">If you haven’t Registed yet ? <a href="register.php">Register Now</a></p>
        </form>
